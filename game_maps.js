...
const MAPS = {
  ...
  world: {
    data: [
      ...
      'mtgfgggwgtgggggfggfggfmm',
      'mttggggwgtgpppppppppggmm',
      'mgggggpwgggpggggggpggmmm',
      'mggggppttbttpggttggpgmmm',
      'mgggppgggggpggttggpggmmm',
      'mggppggfggfpggttgkpggmmm',
      'mgppggfggffpppppppgggmmm',
      'mppgggfggggpggggggggsmmm',
      'mpppppppppppgggggggggmmm',
      'mtgggggwgggggfgfgfggmmmm',
      'mttggggwggggggfgfgggmmmm',
      'mmttgggwwgggggggggggmmmm',
      'mmmttttwwttttttttttmmmmm',
      'mmmmmmmmmmmmmmmmmmmmmmmm',
    ],
    transitions: [
